...
template<u32 window_width, u32 window_height>
VKAPI_ATTR VkBool32 VKAPI_CALL Renderer<window_width, window_height>::debugCallback(
...
template<u32 window_width, u32 window_height>
VkResult Renderer<window_width, window_height>::CreateDebugUtilsMessengerEXT(
    VkInstance instance,
...
template<u32 window_width, u32 window_height>
void Renderer<window_width, window_height>::DestroyDebugUtilsMessengerEXT(
    VkInstance instance, 
...
template<u32 window_width, u32 window_height>
void Renderer<window_width, window_height>::populateDebugMessengerCreateInfo(
